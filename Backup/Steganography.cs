...
{
	/// <summary>
	/// Klasa Koder obs³uguje ukrywanie informacji. Zawiera wszystkie metody potrzebne do tej czynnoœci. Nie rozró¿nia wielkoœci liter.
	/// </summary>
	public class Koder
	{
		/// <summary>
		...
		/// <summary>
		/// Okreœla na ilu bitach Koder zapisuje jeden znak.
		/// </summary>
		...
		public Koder(string msg,Image source,int red,int green,int blue)
		{
			message=msg;
			redBits=(byte)red;
		...
		/// <param name="msg">Wiadomoœæ do zakodowania</param>
		/// <param name="source">Obrazek, w którym ukryjemy wiadomoœæ</param>
		public Koder(string msg,Image source):this(msg,source,1,1,1)
		{
		}
